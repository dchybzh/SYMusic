...
__DEFINE__(1679110733474, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1679110733475,"./event-store":1679110733476}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679110733475, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1679110733476, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1679110733475,"./utils":1679110733477}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679110733477, function(require, module, exports) {
...
return __REQUIRE__(1679110733474);
})()
